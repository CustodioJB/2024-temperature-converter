...
class Converter:
    ...
    def __init__(self):
        ...
        # Conversion History / export buttons
...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        # set maximum number of calculations to 5 this can be changed if we want to shower fewer / more calculations
        max_calcs = 5
        ...
        self.dismiss_button.grid(row = 0, padx = 1, pady = 10)
    ...
    # Close history dialogue (used by button and x at the top of dialogue)
