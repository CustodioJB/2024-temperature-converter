...
class Converter:
    ...
    def __init__(self):
        ...
        # Arial size 14 boldm with white text
    ...
    def check_temp(self, min_value):
        ...
        # check that user has enter a valid number...
        ...
        # If we have no errors...
            ...
            # set to 'no' in case of previous erros
            self.var_has_error.set("no")
...
class DisplayHelp:
    ...
    # Cloes help dialogue (used by button and x at the top of dialogue)
...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        # Set variables to hold filename and date for when writing to file
        ...
        self.dismiss_button = Button(self.button_frame, font=("Arial", "12", "bold"), text="Dismiss", bg="#666666", fg="#FFFFFF", width=12, command=partial(self.close_history,
            partner))
    ...
    # checks filename only has letters, numbers and underscores
    @staticmethod
